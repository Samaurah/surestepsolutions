            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li class="hvr-bounce-in"><a href="<?php echo base_url();?>"><i class="fa fa-home" style="margin-left:20px"></i> Home</a></li>
...
<div class="container" id="content">
	...
	<div class="row">
		<div class="col-md-12 col-xs-12 animated fadeInRight">
			<p>
				<img class="hvr-grow" src="<?php echo base_url();?>Images/logo-support.png">                   
				<img class="hvr-grow" style="margin-left:30px" src="<?php echo base_url();?>Images/dynamicsGO-support.png">
				<img class="hvr-grow" style="margin-left:30px" src="<?php echo base_url();?>Images/dynamicsLogo-support.png">
				<img class="hvr-grow" style="margin-left:30px" src="<?php echo base_url();?>Images/NAV-Support.png">
				<img class="hvr-grow" style="margin-left:30px" src="<?php echo base_url();?>Images/Tab.png">
				<img class="hvr-grow" style="margin-left:30px" src="<?php echo base_url();?>Images/CRMSupport.png">
				<img class="hvr-grow" style="margin-left:30px" src="<?php echo base_url();?>Images/support.png">
			</p>
		</div>
	</div>
	<hr>
	<div class="row animated fadeInUp">
		<div class="col-md-4">
			<p><img src="<?php echo base_url();?>Images/partners2.png"></p>
			<h4>Experienced, Expert, Trusted Partner</h4>
		...
		<div id="panel" class="col-md-4" style="font-size:13px">
			<h3 class="column-title">FAQs</h3>
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingOne">
                                <h4 class="panel-title">
                                    <a data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne" style="font-size:13px">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingTwo">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" style="font-size:13px">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading" role="tab" id="headingThree">
                                <h4 class="panel-title">
                                    <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="false" aria-controls="collapseThree"  style="font-size:13px">
                        ...
                        <p><a href="<?php echo base_url();?>index.php/faqs">More FAQs</a></p>
                    </div>
	...
	<div class="row">
		...
		<div style="padding-top:10px" class="col-md-6">		
			...
			<div class="form-group">				
                <h4>Message</h4>
                <textarea name="messages" class="form-control" rows="5" placeholder="Comment Here"></textarea>     
			</div>
                    ...
                    <div class="row">
                        <div class="col-md-6" id="indent">
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li style="font-size:15px"><i class="fa fa-angle-right"></i>&nbsp;<a id="list" class="hvr-float-shadow" href="#">Budgetary Management Systems</a></li>
                                        <li style="font-size:15px"><i class="fa fa-angle-right"></i>&nbsp;<a id="list" class="hvr-float-shadow" href="#">Property Management Systems</a></li>
                                        <li style="font-size:15px"><i class="fa fa-angle-right"></i>&nbsp;<a id="list" class="hvr-float-shadow" href="#">Fleet Management Systems</a></li>
                                        <li style="font-size:15px"><i class="fa fa-angle-right"></i>&nbsp;<a id="list" class="hvr-float-shadow" href="#">Portfolio Management Systems</a></li>
                                        ...
                                        <li style="font-size:15px"><i class="fa fa-angle-right"></i>&nbsp;<a id="list" class="hvr-float-shadow" href="#">Hospital Management Systems</a></li>
                                    </ul>   
                        ...
                        <div class="col-md-6" id="indent">  
                                    ...
                                    <ul class="list-unstyled">
                                        <li style="font-size:15px"><i class="fa fa-angle-right"></i>&nbsp;<a id="list" class="hvr-float-shadow" href="#">Integrated Academic Management Systems</a></li>
